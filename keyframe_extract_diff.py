...
if __name__ == "__main__":
    envpath = '/home/user1/anaconda3/envs/pytorch/lib/python3.7/site-packages/cv2/qt/plugins/platforms'
    ...
    videopath = './videos/blender_paper_lego_spiral_200000_rgb.mp4'
    # Directory to store the processed frames
    dir = './images/extract_result/'
